...
@section('konten') <!-- Awal section 'konten' yang akan diisi pada layout master -->
    <div class="card"> <!-- Awal card Bootstrap -->
        <div class="card-header">tambah data produk</div> <!-- Header card -->
        <div class="card-body"> <!-- Body card -->
            <form action="/product" method="POST"> <!-- Form untuk menambah produk, dikirim ke /product dengan metode POST -->
                ...
                <div class="row"> <!-- Awal row Bootstrap -->
                    <div class="col-sm-6"> <!-- Kolom kiri (setengah lebar) -->
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_produk" class="form-control" value="{{ old('nama_produk') }}"> <!-- Input nama produk -->
                            @error('nama_produk')
                    ...
                    <div class="col-sm-6"> <!-- Kolom kanan (setengah lebar) -->
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga_produk" class="form-control" value="{{ old('harga_produk') }}"> <!-- Input harga produk -->
                            @error('harga_produk')
                    ...
                    <div class="col-12"> <!-- Kolom penuh untuk deskripsi -->
                        <div class="form-floating">
                            <textarea class="form-control" name="deskripsi" placeholder="Leave a comment here"
                                style="height: 100px"></textarea> <!-- Input textarea deskripsi produk -->
